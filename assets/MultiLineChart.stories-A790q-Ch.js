import{n as e,s as t}from"./factories-9e-l2P_s.js";import{t as n}from"./MultiLineChart-CU4F7M6Y.js";var r={title:`Components/Deprecated/MultiLineChart`,component:n,tags:[`autodocs`],argTypes:{height:{control:`number`},showLegend:{control:`boolean`},isLoading:{control:`boolean`}}},i={args:{data:e(24,[`voltage`]),title:`Voltaj Geçmişi`,yAxisLabel:`Voltaj (V)`}},a=e(24,[`voltage`,`current`,`power`]),[o,s,c]=a,l={args:{data:a,title:`Çoklu Seri Grafiği`,yAxisLabel:`Değer`}},u={args:{data:a,title:`Anotasyonlu Grafik`,yAxisLabel:`Değer`,annotations:o&&s&&c?[t({type:`warning`,timestamp:o.timestamp,message:`Voltaj düşüşü`}),t({type:`error`,timestamp:s.timestamp,message:`Akım kesintisi`}),t({type:`info`,timestamp:c.timestamp,message:`Sistem normale döndü`})]:void 0}},d={args:{data:[],isLoading:!0}},f={args:{data:[]}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  args: {
