import{t as e}from"./LogTerminal-DYcOqay8.js";import{a as t,i as n}from"./factories-DiEsIEH4.js";var r={title:`Components/LogTerminal`,component:e,tags:[`autodocs`]},i={args:{provider:t([n({type:`info`,source:`system`,message:`Sistem başlatıldı`}),n({type:`success`,source:`user`,message:`BSC-1 şarj moduna geçirildi`}),n({type:`info`,source:`system`,message:`Modbus bağlantısı kuruldu`}),n({type:`warning`,source:`system`,message:`BSC-2 sıcaklık eşiği aşıldı`,details:`Sıcaklık: 52°C, Eşik: 50°C`}),n({type:`success`,source:`user`,message:`Raf konfigürasyonu güncellendi`}),n({type:`error`,source:`system`,message:`TMS-3 haberleşme hatası`,details:`Timeout: 5000ms`}),n({type:`info`,source:`user`,message:`Log görüntüleme filtresi değiştirildi`}),n({type:`success`,source:`system`,message:`TimescaleDB yazma başarılı`}),n({type:`warning`,source:`user`,message:`Manuel deşarj limiti düşük`,details:`Limit: %10`}),n({type:`error`,source:`system`,message:`Redis bağlantısı kesildi`,details:`Yeniden bağlanılıyor...`})]),maxHeight:400}},a={args:{provider:t([])}},o={args:{provider:t(Array.from({length:55},(e,t)=>n({type:[`info`,`success`,`warning`,`error`][t%4],source:[`system`,`user`][t%2],message:`Log kaydı #${t+1} - ${t%4==0?`bilgi`:t%4==1?`başarılı`:t%4==2?`uyarı`:`hata`}`}))),maxHeight:400}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  args: {
