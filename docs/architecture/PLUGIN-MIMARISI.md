...
> **Durum:** Uygulanmış (Faz 1–4). Faz 5 (web-service + UI) sıradadır. EPİAŞ veri analizi ve erişim durumu: [EPIAS-VERI-ANALIZI.md](../analysis/EPIAS-VERI-ANALIZI.md).
