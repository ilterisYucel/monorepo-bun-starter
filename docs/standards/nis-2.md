...
status: active
space: standards
tags: [nis2, guvenlik, uyumluluk, sonarqube, ci-cd]
...
**ASVS Notu:** Profil, [OWASP ASVS Level 2 doğrulama matrisine](./owasp-asvs-level2.md) göre eşlenir. SAST yalnızca ASVS'nin otomatize edilebilen kısmını (V5, V6, V13, V14 kuralları) doğrular; V1-V4, V7, V8'in geri kalanı test, manuel inceleme ve pentest ile kanıtlanır — SAST temiz çıktı tek başına "ASVS uyumlu" anlamına gelmez.
