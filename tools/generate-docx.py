...
MARKDOWN_PATH = os.path.join(os.path.dirname(__file__), "..", "docs", "product", "proje-tanitim-raporu.md")
LOGO_PATH = os.path.join(os.path.dirname(__file__), "..", "docs", "assets", "logo.png")
ARCH_IMG_PATH = os.path.join(os.path.dirname(__file__), "..", "docs", "assets", "images", "architecture.png")
OUTPUT_PATH = os.path.join(os.path.dirname(__file__), "..", "docs", "archived", "GD-ESS-EYS-Yazilim-Tanitim-Dokumani.docx")
