...
const chargeUnit: BSCUnit = createMockBSCUnit({
  ...
  racks: [
    ...
    rack({ id: 5, name: "Rack-5", status: "online", charge_status: "Charge", soc: 91 }),
    rack({ id: 6, name: "Rack-6", status: "online", charge_status: "Charge", soc: 64 }),
    rack({ id: 7, name: "Rack-7", status: "online", charge_status: "Discharge", soc: 27 }),
    rack({ id: 8, name: "Rack-8", status: "offline", charge_status: "Idle", soc: 0 }),
  ],
...
const unit2: BSCUnit = createMockBSCUnit({
  ...
  racks: [
    ...
    rack({ id: 9, deviceId: "BSC-2", name: "Rack-9", status: "online", charge_status: "Charge", soc: 88 }),
    rack({ id: 10, deviceId: "BSC-2", name: "Rack-10", status: "online", charge_status: "Discharge", soc: 33 }),
    rack({ id: 11, deviceId: "BSC-2", name: "Rack-11", status: "online", charge_status: "Charge", soc: 57 }),
    rack({ id: 12, deviceId: "BSC-2", name: "Rack-12", status: "offline", charge_status: "Idle", soc: 0 }),
  ],
  breakerStatus: "online",
  breakerPosition: "close",
