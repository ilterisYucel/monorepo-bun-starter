// packages/ui/src/components/PowerFlowAnimation/PowerFlowCanvas.tsx
...
export const PowerFlowCanvas: React.FC<PowerFlowCanvasProps> = ({
  ...
  const draw = useCallback(
    (ctx: CanvasRenderingContext2D, timestamp: number) => {
      ...
      const chargeColor = `hsl(${80 + progress * 40}, 100%, 50%)`;
      const dischargeColor = `hsl(${30 + progress * 210}, 100%, 50%)`;
