...
import type { TMSGraphicProps, StepConfig, TMSLayout } from "../TMSGraphic/TMSGraphic.types";
import { calculateStepConfig, getTMSLayout } from "../TMSGraphic/TMSGraphic.utils";
import { useWebGLDetect, usePixiResize, usePixiTicker } from "../TMSGraphic/TMSGraphic.hooks";
import { usePixiZoom } from "../../hooks/usePixiZoom";
import { SCADA_ICONS } from "../../icons";
import { RoomCard, HvacUnit, PanelCard } from "../../core";

import * as S from "./TMSGraphicV2.styles";

extend({ Container, Graphics, Text, Sprite });

export const TMSGraphicV2: React.FC<TMSGraphicProps> = React.memo(
...
TMSGraphicV2.displayName = "TMSGraphicV2";
