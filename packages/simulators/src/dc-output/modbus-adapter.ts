...
import { DcOutputSimulator } from "./simulator";

export class DcOutputSimulatorAdapter implements IModbusSimulatorAdapter {
  constructor(private simulator: DcOutputSimulator) {}
