...
import { EnergyAnalyzerSimulator } from "./simulator";

export class EnergyAnalyzerSimulatorAdapter implements IModbusSimulatorAdapter {
  constructor(private simulator: EnergyAnalyzerSimulator) {}
